        ...
        with open(labels, "r") as f:
            ...
            while(line):
                ...
                if(curr == frame):
                    ...
                    x = [center_x - width/2, center_x - width/2, center_x + width/2, center_x + width/2, 
                        center_x - width/2, center_x - width/2, center_x + width/2, center_x + width/2]

                    y = [center_y - length/2, center_y + length/2, center_y + length/2, center_y - length/2,
                        center_y - length/2, center_y + length/2, center_y + length/2, center_y - length/2]

                    z = [center_z - depth/2, center_z - depth/2, center_z - depth/2, center_z - depth/2,
                        center_z + depth/2, center_z + depth/2, center_z + depth/2, center_z + depth/2]

                    

                    # plot the box
                    ax.plot_trisurf(x, y, z, linewidth=0.2, edgecolor='black', alpha=0.5)
                else:
